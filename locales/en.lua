local Translations = {
    ...
    info = {
        ...
        ["maximum_cars"]        = "There can be a maximum of ~r~%{amount}~s~ cars can be parked outside on the street, and the limit has been reached, you must park this vehicle in the parking garage!",
