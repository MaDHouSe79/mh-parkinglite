local Translations = {
    ...
    info = {
        ...
        ["maximum_cars"]        = "Er kunnen maximaal ~r~%{amount}~s~ auto's buiten op straat gepakeerd worden, en de limiet is bereikt, u moet dit voertuig in de pakeer garage parkeren!",
